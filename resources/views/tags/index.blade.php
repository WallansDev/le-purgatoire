                    ...
                    <form method="GET" action="{{ route('tags.index') }}" class="mb-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex gap-2">
                                <button type="submit"
                                    class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">Rechercher</button>
                                @if (request('search') || request('organization_id'))
                                    <a href="{{ route('tags.index') }}"
                                        class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Réinitialiser</a>
                                @endif
                            </div>
                        </div>
                    </form>
