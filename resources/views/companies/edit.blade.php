                    ...
                    <form action="{{ route('companies.update', $company) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="siret" class="block mt-1 w-full" type="text" name="siret" :value="old('siret', $company->siret)" />
                                <x-input-error :messages="$errors->get('siret')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="address_line1" :value="__('Adresse ligne 1')" />
                                <x-text-input id="address_line1" class="block mt-1 w-full" type="text" name="address_line1" :value="old('address_line1', $company->address_line1)" />
                                <x-input-error :messages="$errors->get('address_line1')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="address_line2" :value="__('Adresse ligne 2')" />
                                <x-text-input id="address_line2" class="block mt-1 w-full" type="text" name="address_line2" :value="old('address_line2', $company->address_line2)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="logo_path" class="block mt-1 w-full" type="text" name="logo_path" :value="old('logo_path', $company->logo_path)" />
                                <x-input-error :messages="$errors->get('logo_path')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="contact_name" :value="__('Nom du contact')" />
                                <x-text-input id="contact_name" class="block mt-1 w-full" type="text" name="contact_name" :value="old('contact_name', $company->contact_name)" />
                                <x-input-error :messages="$errors->get('contact_name')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="contact_email" :value="__('Email du contact')" />
                                <x-text-input id="contact_email" class="block mt-1 w-full" type="email" name="contact_email" :value="old('contact_email', $company->contact_email)" />
