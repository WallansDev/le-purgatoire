                    ...
                    <form action="{{ route('interventions.update', $intervention) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <label class="inline-flex items-center mb-2">
                                        <input type="checkbox" id="no_service_note" name="no_service_note" value="1" {{ old('no_service_note', is_null($intervention->service_note)) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                                        <span class="ml-2 text-sm text-gray-600">Non notée</span>
                                    </label>
                                </div>
                                <x-text-input id="service_note" class="block mt-1 w-full" type="number" name="service_note" :value="old('service_note', $intervention->service_note !== null ? $intervention->service_note : '')" min="0" max="5" />
