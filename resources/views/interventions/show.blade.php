                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900">{{ $intervention->scheduled_at?->format('d/m/Y à H:i') ?? '-' }}
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900">{{ $intervention->finished_at?->format('d/m/Y à H:i') ?? '-' }}
                            </p>
                        </div>
                        <div>
                                ...
                                <div class="flex flex-wrap gap-2 mt-1">
                                    @foreach ($intervention->tags as $tag)
                                        <span
                                            ...
                                            style="border-color: {{ $tag->color ?? '#c7d2fe' }}; color: {{ $tag->color ?? '#4f46e5' }}">
                                            {{ $tag->name }}
                                        </span>
                                    @endforeach
                                </div>
